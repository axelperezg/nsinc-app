...
return [
    ...
    | predeterminados utilizados por la clase de validador. Algunas de estas
    | reglas tienen múltiples versiones, como las reglas de tamaño.
    | Siéntase libre de modificar cada uno de estos mensajes.
    |
    */
    ...
    | líneas. Esto facilita especificar rápidamente una línea de idioma
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de idioma se utilizan para intercambiar los
    ...
    */
    ...
    'attributes' => [
        ...
        'mision' => 'misión',
        'vision' => 'visión',
        'objetivo_institucional' => 'objetivo institucional',
        'objetivo_estrategia' => 'objetivo de la estrategia',
        'presupuesto' => 'presupuesto',
        'temaEspecifico' => 'tema específico',
        'objetivoComunicacion' => 'objetivo de comunicación',
        'caracEspecific' => 'características específicas',
        'poblacion' => 'población',
        'edad' => 'edad',

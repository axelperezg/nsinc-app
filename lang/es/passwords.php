...
return [
    ...
    | coinciden con las razones que proporciona el administrador de contraseñas
    | para un intento de actualización de contraseña que ha fallado, como por
    | un token no válido o una contraseña nueva no válida.
    |
    */

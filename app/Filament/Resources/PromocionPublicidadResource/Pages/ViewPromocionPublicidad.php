...
class ViewPromocionPublicidad extends ViewRecord
{
    ...
    //             ->redirect(PromocionPublicidadResource::getUrl('index'));
    //     }
    ...
    //             ->color('info')
    //             ->url(PromocionPublicidadResource::getUrl('index'))
    //             ->openUrlInNewTab();
    //     }
    ...
    //             ->color('warning')
    //             ->url(PromocionPublicidadResource::getUrl('modificar', ['record' => $this->record->id]))
    //             ->requiresConfirmation()

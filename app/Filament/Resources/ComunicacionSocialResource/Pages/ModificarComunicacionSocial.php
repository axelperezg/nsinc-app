...
class ModificarComunicacionSocial extends Page
{
    ...
    {
        try {
            $existing = ComunicacionSocialResource::findActiveDerivada(
            ...
            if ($existing) {
                ...
                $this->redirect(static::getResource()::getUrl('edit', ['record' => $existing->id]));
                return;
            }
            ...
            $this->redirect(static::getResource()::getUrl('edit', ['record' => $estrategyNueva->id]));
